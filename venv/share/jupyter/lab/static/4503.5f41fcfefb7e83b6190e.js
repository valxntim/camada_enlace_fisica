...
`.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
  ...
  :host([appearance='hypertext']) .control:visited {
    background: transparent;
    color: ${Vr};
    border-bottom: calc(${Xt} * 1px) solid ${Vr};
  }
...
`;const Zi=(e,t)=>Xa.css`
  ...
  `.withBehaviors(new qi(Xi(e,t),Ui(e,t)));class Yi extends be.Avatar{}ii([(0,Xa.attr)({attribute:"src"})],Yi.prototype,"imgSrc",void 0);ii([Xa.attr],Yi.prototype,"alt",void 0);const Ji=Xa.html`
  ${(0,Xa.when)((e=>e.imgSrc),Xa.html`
      ...
      />
    `)}
`;const Ki=Yi.compose({baseName:"avatar",baseClass:be.Avatar,template:be.avatarTemplate,styles:Zi,media:Ji,shadowOptions:{delegatesFocus:true}});const Qi=(e,t)=>Xa.css`
...
`;const en=be.Badge.compose({baseName:"badge",template:be.badgeTemplate,styles:Qi});const tn=(e,t)=>Xa.css`
  ${(0,be.display)("inline-block")} :host {
    box-sizing: border-box;
    font-family: ${It};
    font-size: ${Yt};
...
`;const on=be.Breadcrumb.compose({baseName:"breadcrumb",template:be.breadcrumbTemplate,styles:tn});const rn=(e,t)=>Xa.css`
    ${(0,be.display)("inline-flex")} :host {
        background: transparent;
        box-sizing: border-box;
        font-family: ${It};
...
`.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));const an=be.BreadcrumbItem.compose({baseName:"breadcrumb-item",template:be.breadcrumbItemTemplate,styles:rn,separator:"/",shadowOptions:{delegatesFocus:true}});const nn=(e,t)=>Xa.css`
    :host([disabled]),
    :host([disabled]:hover),
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));class pn extends be.Card{connectedCallback(){super.connectedCallback();const e=(0,be.composedParent)(this);if(e){lr.setValueFor(this,(t=>Jr.getValueFor(t).evaluate(t,lr.getValueFor(e))))}}}const gn=pn.compose({baseName:"card",baseClass:be.Card,template:be.cardTemplate,styles:hn});const bn=(e,t)=>Xa.css`
    ${(0,be.display)("inline-flex")} :host {
      align-items: center;
      outline: none;
...
`;class mn extends be.Checkbox{indeterminateChanged(e,t){if(this.indeterminate){this.classList.add("indeterminate")}else{this.classList.remove("indeterminate")}}}const vn=mn.compose({baseName:"checkbox",baseClass:be.Checkbox,template:fn,styles:bn,checkedIndicator:`\n        <svg\n            part="checked-indicator"\n            class="checked-indicator"\n            viewBox="0 0 20 20"\n            xmlns="http://www.w3.org/2000/svg"\n        >\n            <path\n                fill-rule="evenodd"\n                clip-rule="evenodd"\n                d="M8.143 12.6697L15.235 4.5L16.8 5.90363L8.23812 15.7667L3.80005 11.2556L5.27591 9.7555L8.143 12.6697Z"\n            />\n        </svg>\n    `,indeterminateIndicator:`\n        <div part="indeterminate-indicator" class="indeterminate-indicator"></div>\n    `});const $n=(e,t)=>{const o=e.tagFor(be.ListboxOption);const r=e.name===e.tagFor(be.ListboxElement)?"":".listbox";return Xa.css`
...
:host(:${be.focusVisible}:not([disabled])) {
    ...
    `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
            ...
            `))};const xn=(e,t)=>{const o=e.name===e.tagFor(be.Select);return Xa.css`
...
`;const In=Nn.compose({baseName:"date-field",styles:Rn,template:Pn,shadowOptions:{delegatesFocus:true}});const An={toView(e){if(e===null||e===undefined){return null}return e===null||e===void 0?void 0:e.toColorString()},fromView(e){if(e===null||e===undefined){return null}const t=S(e);return t?se.create(t.r,t.g,t.b):null}};const Mn=Xa.css`
  :host {
    background-color: ${lr};
    color: ${na};
  }
...
`;const Xn=be.Dialog.compose({baseName:"dialog",template:be.dialogTemplate,styles:Un});const Zn=(e,t)=>Xa.css`
  .disclosure {
...
`;class Yn extends be.Disclosure{constructor(){super(...arguments);this.height=0;this.totalHeight=0}connectedCallback(){super.connectedCallback();if(!this.appearance){this.appearance="accent"}}appearanceChanged(e,t){if(e!==t){this.classList.add(t);this.classList.remove(e)}}onToggle(){super.onToggle();this.details.style.setProperty("height",`${this.disclosureHeight}px`)}setup(){super.setup();const e=()=>this.details.getBoundingClientRect().height;this.show();this.totalHeight=e();this.hide();this.height=e();if(this.expanded){this.show()}}get disclosureHeight(){return this.expanded?this.totalHeight:this.height}}ii([Xa.attr],Yn.prototype,"appearance",void 0);const Jn=Yn.compose({baseName:"disclosure",baseClass:be.Disclosure,template:be.disclosureTemplate,styles:Zn});const Kn=(e,t)=>Xa.css`
  ${(0,be.display)("block")} :host {
...
`;const Qn=be.Divider.compose({baseName:"divider",template:be.dividerTemplate,styles:Kn});class el extends be.ListboxElement{sizeChanged(e,t){super.sizeChanged(e,t);this.updateComputedStylesheet()}updateComputedStylesheet(){if(this.computedStylesheet){this.$fastController.removeStyles(this.computedStylesheet)}const e=`${this.size}`;this.computedStylesheet=Xa.css`
    ...
    `;this.$fastController.addStyles(this.computedStylesheet)}}const tl=el.compose({baseName:"listbox",baseClass:be.ListboxElement,template:be.listboxTemplate,styles:$n});const ol=(e,t)=>Xa.css`
    ${(0,be.display)("block")} :host {
      --elevation: 11;
      background: ${lr};
      border: calc(${Xt} * 1px) solid transparent;
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));class rl extends be.Menu{connectedCallback(){super.connectedCallback();lr.setValueFor(this,Ko)}}const al=rl.compose({baseName:"menu",template:be.menuTemplate,styles:ol});const il=(e,t)=>Xa.css`
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `),new qi(Xa.css`
      ...
      `));const nl=be.MenuItem.compose({baseName:"menu-item",template:be.menuItemTemplate,styles:il,checkboxIndicator:`\n        <svg\n            part="checkbox-indicator"\n            class="checkbox-indicator"\n            viewBox="0 0 20 20"\n            xmlns="http://www.w3.org/2000/svg"\n        >\n            <path\n                fill-rule="evenodd"\n                clip-rule="evenodd"\n                d="M8.143 12.6697L15.235 4.5L16.8 5.90363L8.23812 15.7667L3.80005 11.2556L5.27591 9.7555L8.143 12.6697Z"\n            />\n        </svg>\n    `,expandCollapseGlyph:`\n        <svg\n            viewBox="0 0 16 16"\n            xmlns="http://www.w3.org/2000/svg"\n            class="expand-collapse-glyph"\n            part="expand-collapse-glyph"\n        >\n            <path\n                d="M5.00001 12.3263C5.00124 12.5147 5.05566 12.699 5.15699 12.8578C5.25831 13.0167 5.40243 13.1437 5.57273 13.2242C5.74304 13.3047 5.9326 13.3354 6.11959 13.3128C6.30659 13.2902 6.4834 13.2152 6.62967 13.0965L10.8988 8.83532C11.0739 8.69473 11.2153 8.51658 11.3124 8.31402C11.4096 8.11146 11.46 7.88966 11.46 7.66499C11.46 7.44033 11.4096 7.21853 11.3124 7.01597C11.2153 6.81341 11.0739 6.63526 10.8988 6.49467L6.62967 2.22347C6.48274 2.10422 6.30501 2.02912 6.11712 2.00691C5.92923 1.9847 5.73889 2.01628 5.56823 2.09799C5.39757 2.17969 5.25358 2.30817 5.153 2.46849C5.05241 2.62882 4.99936 2.8144 5.00001 3.00369V12.3263Z"\n            />\n        </svg>\n    `,radioIndicator:`\n        <span part="radio-indicator" class="radio-indicator"></span>\n    `});const ll=(e,t)=>Xa.css`
  ${Hn}
...
`;class sl extends be.NumberField{constructor(){super(...arguments);this.appearance="outline"}}ii([Xa.attr],sl.prototype,"appearance",void 0);const cl=sl.compose({baseName:"number-field",baseClass:be.NumberField,styles:ll,template:be.numberFieldTemplate,shadowOptions:{delegatesFocus:true},stepDownGlyph:`\n        <span class="step-down-glyph" part="step-down-glyph"></span>\n    `,stepUpGlyph:`\n        <span class="step-up-glyph" part="step-up-glyph"></span>\n    `});const dl=(e,t)=>Xa.css`
    ${(0,be.display)("inline-flex")} :host {
      align-items: center;
      font-family: ${It};
      border-radius: calc(${Et} * 1px);
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));const ul=be.ListboxOption.compose({baseName:"option",template:be.listboxOptionTemplate,styles:dl});const hl=(e,t)=>Xa.css`
    ${(0,be.display)("flex")} :host {
      align-items: center;
      outline: none;
      height: calc(${qt} * 1px);
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));const pl=be.BaseProgress.compose({baseName:"progress",template:be.progressTemplate,styles:hl,indeterminateIndicator1:`\n        <span class="indeterminate-indicator-1" part="indeterminate-indicator-1"></span>\n    `,indeterminateIndicator2:`\n        <span class="indeterminate-indicator-2" part="indeterminate-indicator-2"></span>\n    `});const gl=(e,t)=>Xa.css`
    ${(0,be.display)("flex")} :host {
      align-items: center;
      outline: none;
      height: calc(${Ja} * 1px);
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));const bl=be.BaseProgress.compose({baseName:"progress-ring",template:be.progressRingTemplate,styles:gl,indeterminateIndicator:`\n        <svg class="progress" part="progress" viewBox="0 0 16 16">\n            <circle\n                class="background"\n                part="background"\n                cx="8px"\n                cy="8px"\n                r="7px"\n            ></circle>\n            <circle\n                class="indeterminate-indicator-1"\n                part="indeterminate-indicator-1"\n                cx="8px"\n                cy="8px"\n                r="7px"\n            ></circle>\n        </svg>\n    `});const fl=(e,t)=>Xa.css`
    ${(0,be.display)("inline-flex")} :host {
...
`;class vl extends be.Radio{}const $l=vl.compose({baseName:"radio",baseClass:be.Radio,template:ml,styles:fl,checkedIndicator:`\n        <div part="checked-indicator" class="checked-indicator"></div>\n    `});const xl=(e,t)=>Xa.css`
  ${(0,be.display)("flex")} :host {
...
`;class yl extends be.RadioGroup{constructor(){super();const e=Xa.Observable.getNotifier(this);const t={handleChange(e,t){if(t==="slottedRadioButtons"){e.ariaInvalidChanged()}}};e.subscribe(t,"slottedRadioButtons")}ariaInvalidChanged(){if(this.slottedRadioButtons){this.slottedRadioButtons.forEach((e=>{var t;e.setAttribute("aria-invalid",(t=this.getAttribute("aria-invalid"))!==null&&t!==void 0?t:"false")}))}}}const wl=yl.compose({baseName:"radio-group",baseClass:be.RadioGroup,template:be.radioGroupTemplate,styles:xl});const kl=be.DesignToken.create("clear-button-hover").withDefault((e=>{const t=Mr.getValueFor(e);const o=zr.getValueFor(e);return t.evaluate(e,o.evaluate(e).hover).hover}));const Fl=be.DesignToken.create("clear-button-active").withDefault((e=>{const t=Mr.getValueFor(e);const o=zr.getValueFor(e);return t.evaluate(e,o.evaluate(e).hover).active}));const Cl=(e,t)=>Xa.css`
  ${Hn}
...
`;class Sl extends be.Search{constructor(){super(...arguments);this.appearance="outline"}}ii([Xa.attr],Sl.prototype,"appearance",void 0);const Vl=Sl.compose({baseName:"search",baseClass:be.Search,template:be.searchTemplate,styles:Cl,shadowOptions:{delegatesFocus:true}});const Tl=Cl;class Dl extends be.Select{constructor(){super(...arguments);this.listboxScrollWidth=""}autoWidthChanged(e,t){if(t){this.setAutoWidth()}else{this.style.removeProperty("width")}}setAutoWidth(){if(!this.autoWidth||!this.isConnected){return}let e=this.listbox.getBoundingClientRect().width;if(e===0&&this.listbox.hidden){Object.assign(this.listbox.style,{visibility:"hidden"});this.listbox.removeAttribute("hidden");e=this.listbox.getBoundingClientRect().width;this.listbox.setAttribute("hidden","");this.listbox.style.removeProperty("visibility")}if(e>0){Object.assign(this.style,{width:`${e}px`})}}connectedCallback(){super.connectedCallback();this.setAutoWidth();if(this.listbox){lr.setValueFor(this.listbox,Ko)}}slottedOptionsChanged(e,t){super.slottedOptionsChanged(e,t);this.setAutoWidth()}get listboxMaxHeight(){return Math.floor(this.maxHeight/ga.getValueFor(this)).toString()}listboxScrollWidthChanged(){this.updateComputedStylesheet()}get selectSize(){var e;return`${(e=this.size)!==null&&e!==void 0?e:this.multiple?4:0}`}multipleChanged(e,t){super.multipleChanged(e,t);this.updateComputedStylesheet()}maxHeightChanged(e,t){if(this.collapsible){this.updateComputedStylesheet()}}setPositioning(){super.setPositioning();this.updateComputedStylesheet()}sizeChanged(e,t){super.sizeChanged(e,t);this.updateComputedStylesheet();if(this.collapsible){requestAnimationFrame((()=>{this.listbox.style.setProperty("display","flex");this.listbox.style.setProperty("overflow","visible");this.listbox.style.setProperty("visibility","hidden");this.listbox.style.setProperty("width","auto");this.listbox.hidden=false;this.listboxScrollWidth=`${this.listbox.scrollWidth}`;this.listbox.hidden=true;this.listbox.style.removeProperty("display");this.listbox.style.removeProperty("overflow");this.listbox.style.removeProperty("visibility");this.listbox.style.removeProperty("width")}));return}this.listboxScrollWidth=""}updateComputedStylesheet(){if(this.computedStylesheet){this.$fastController.removeStyles(this.computedStylesheet)}this.computedStylesheet=Xa.css`
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));const Bl=be.Skeleton.compose({baseName:"skeleton",template:be.skeletonTemplate,styles:zl});const Ll=Xa.css`
  .track-start {
    left: 0;
  }
`;const Ol=Xa.css`
...
`;const Nl=(e,t)=>Xa.css`
  ...
  `.withBehaviors(new qi(Ll,Ol),(0,be.forcedColorsStylesheetBehavior)(Xa.css`
      .thumb-cursor {
        forced-color-adjust: none;
        border-color: ${Ya.FieldText};
        background: ${Ya.FieldText};
    ...
    `));class Hl extends be.Slider{}const Rl=Hl.compose({baseName:"slider",baseClass:be.Slider,template:be.sliderTemplate,styles:Nl,thumb:`\n        <div class="thumb-cursor"></div>\n    `});var Pl=o(62899);const Il=Xa.css`
  :host {
    align-self: start;
    grid-row: 2;
    margin-top: -2px;
...
`;const Ml=(e,t)=>Xa.css`
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));class Gl extends be.SliderLabel{sliderOrientationChanged(){if(this.sliderOrientation===Pl.i.horizontal){this.$fastController.addStyles(Il);this.$fastController.removeStyles(Al)}else{this.$fastController.addStyles(Al);this.$fastController.removeStyles(Il)}}}const El=Gl.compose({baseName:"slider-label",baseClass:be.SliderLabel,template:be.sliderLabelTemplate,styles:Ml});const _l=(e,t)=>Xa.css`
    :host([hidden]) {
      display: none;
    }
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `),new qi(Xa.css`
      ...
      `));class ql extends be.Switch{}const Wl=ql.compose({baseName:"switch",baseClass:be.Switch,template:be.switchTemplate,styles:_l,switch:`\n        <span class="checked-indicator" part="checked-indicator"></span>\n    `});const Ul=(e,t)=>Xa.css`
  ${(0,be.display)("block")} :host {
    box-sizing: border-box;
    font-size: ${Yt};
    line-height: ${Jt};
...
`;const Xl=be.TabPanel.compose({baseName:"tab-panel",template:be.tabPanelTemplate,styles:Ul});const Zl=(e,t)=>Xa.css`
    ${(0,be.display)("inline-flex")} :host {
      box-sizing: border-box;
      font-family: ${It};
      font-size: ${Yt};
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));const Yl=be.Tab.compose({baseName:"tab",template:be.tabTemplate,styles:Zl});const Jl=(e,t)=>Xa.css`
    ${(0,be.display)("grid")} :host {
      box-sizing: border-box;
      font-family: ${It};
      font-size: ${Yt};
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));const Kl=be.Tabs.compose({baseName:"tabs",template:be.tabsTemplate,styles:Jl});const Ql=(e,t)=>Xa.css`
    ${(0,be.display)("inline-block")} :host {
      font-family: ${It};
      outline: none;
      user-select: none;
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `));class es extends be.TextArea{constructor(){super(...arguments);this.appearance="outline"}}ii([Xa.attr],es.prototype,"appearance",void 0);const ts=es.compose({baseName:"text-area",baseClass:be.TextArea,template:be.textAreaTemplate,styles:Ql,shadowOptions:{delegatesFocus:true}});const os=(e,t)=>Xa.css`
  ${Hn}
...
`;class rs extends be.TextField{constructor(){super(...arguments);this.appearance="outline"}}ii([Xa.attr],rs.prototype,"appearance",void 0);const as=rs.compose({baseName:"text-field",baseClass:be.TextField,template:be.textFieldTemplate,styles:os,shadowOptions:{delegatesFocus:true}});var is=o(62540);var ns=o(88388);const ls=(e,t)=>Xa.css`
    ${(0,be.display)("inline-flex")} :host {
  ...
  `.withBehaviors((0,be.forcedColorsStylesheetBehavior)(Xa.css`
    ...
    `))};const gs=be.Tooltip.compose({baseName:"tooltip",template:be.tooltipTemplate,styles:ps});const bs=Xa.css`
  .expand-collapse-glyph {
    transform: rotate(0deg);
  }
...
`;const ms=Xa.cssPartial`((${At} / 2) * ${qt}) + ((${qt} * ${_t}) / 2)`;const vs=be.DesignToken.create("tree-item-expand-collapse-hover").withDefault((e=>{const t=Mr.getValueFor(e);return t.evaluate(e,t.evaluate(e).hover).hover}));const $s=be.DesignToken.create("tree-item-expand-collapse-selected-hover").withDefault((e=>{const t=zr.getValueFor(e);const o=Mr.getValueFor(e);return o.evaluate(e,t.evaluate(e).rest).hover}));const xs=(e,t)=>Xa.css`
    /**
    ...
    .expand-collapse-button {
      ...
      outline: none;
      /* TODO: adaptive typography https://github.com/microsoft/fast/issues/2432 */
      width: calc((${ms} + (${qt} * 2)) * 1px);
      height: calc((${ms} + (${qt} * 2)) * 1px);
      padding: 0;
      display: flex;
      justify-content: center;
      align-items: center;
  ...
  `.withBehaviors(new qi(bs,fs),(0,be.forcedColorsStylesheetBehavior)(Xa.css`
      :host {
        forced-color-adjust: none;
        border-color: transparent;
        background: ${Ya.Field};
    ...
    `));const ys=be.TreeItem.compose({baseName:"tree-item",template:be.treeItemTemplate,styles:xs,expandCollapseGlyph:`\n        <svg\n            viewBox="0 0 16 16"\n            xmlns="http://www.w3.org/2000/svg"\n            class="expand-collapse-glyph"\n        >\n            <path\n                d="M5.00001 12.3263C5.00124 12.5147 5.05566 12.699 5.15699 12.8578C5.25831 13.0167 5.40243 13.1437 5.57273 13.2242C5.74304 13.3047 5.9326 13.3354 6.11959 13.3128C6.30659 13.2902 6.4834 13.2152 6.62967 13.0965L10.8988 8.83532C11.0739 8.69473 11.2153 8.51658 11.3124 8.31402C11.4096 8.11146 11.46 7.88966 11.46 7.66499C11.46 7.44033 11.4096 7.21853 11.3124 7.01597C11.2153 6.81341 11.0739 6.63526 10.8988 6.49467L6.62967 2.22347C6.48274 2.10422 6.30501 2.02912 6.11712 2.00691C5.92923 1.9847 5.73889 2.01628 5.56823 2.09799C5.39757 2.17969 5.25358 2.30817 5.153 2.46849C5.05241 2.62882 4.99936 2.8144 5.00001 3.00369V12.3263Z"\n            />\n        </svg>\n    `});const ws=(e,t)=>Xa.css`
  ${(0,be.display)("flex")} :host {
    flex-direction: column;
    align-items: stretch;
...
`;const ks=be.TreeView.compose({baseName:"tree-view",template:be.treeViewTemplate,styles:ws});const Fs=(e,t)=>Xa.css`
  .region {
    z-index: 1000;
    overflow: hidden;
    display: flex;
